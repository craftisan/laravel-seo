...
return [
    ...
    'admin' => [
        ...
        'page_warning' => 'Pages not created',
        'no_variables_warning' => 'You have not put any variables in this template',
        'variable_spellcheck' => 'Invalid variable name :variable. Please type the correct name for all the variables. Refer to the \'Variable Reference\' section',
        'variable_value_empty' => 'Please select a value for all the variables in the template',
        'variable_mismatch' => 'The content has more variables than the original (parent) template',
        'variable_not_allowed' => 'Variables are not allowed while editing a page. To insert variables please create the page from existing templates or create a new one!',
