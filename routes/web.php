...
Route::group(['prefix' => 'seo'], function () {
    Route::get('templates/{id}/duplicate', SeoTemplateController::class . '@duplicate');
    Route::resource('templates', SeoTemplateController::class);
    Route::get('pages/{id}/duplicate', SeoPageController::class . '@duplicate');
